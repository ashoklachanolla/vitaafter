 ...
 */
static void callbackMessageReceived( struct mosquitto *pMsqt, void * context, const struct mosquitto_message * message)
{
 ...
 */
static void callbackDisconnected(mosquitto *pMsqt,  void * context, int a)
{
    RaspberryOSIOClient * _this = (RaspberryOSIOClient *)context;
...
bool RaspberryOSIOClient::publish(char* topic, char* payload) 
{
    ...
    int result = mosquitto_publish(this->_data, 0, topic, strlen(payload), (const void*)payload, 0, false);
